    ...
    try:
        ...
        response = gemini_client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                ...
                temperature=0.1,
                # Default is 10 remote calls, which lets Gemini retry a slow
                # tool up to 10x in one request. Cap to 1 tool-call turn
                # (2 = 1 tool call + 1 final synthesis) so a single chat
                # request has a predictable worst-case latency.
